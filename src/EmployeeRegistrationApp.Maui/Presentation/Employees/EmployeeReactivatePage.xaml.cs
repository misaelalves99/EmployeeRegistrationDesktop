...
namespace EmployeeRegistrationApp.Maui.Presentation.Employees.Views
{
    ...
    public partial class EmployeeReactivatePage : ContentPage
    {
        private readonly EmployeeReactivateViewModel _viewModel;
        ...
        public EmployeeReactivatePage(EmployeeReactivateViewModel viewModel)
        {
            InitializeComponent();
